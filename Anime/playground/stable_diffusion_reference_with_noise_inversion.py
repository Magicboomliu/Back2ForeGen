...
class StableDiffusionReferencePipeline(
    ...
    def __call__(
        ...
        inverted_latents, inversion_prompt = ddim_inversion(start_latents=ref_image_latents,prompt="",
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if ref_xt.shape[0]>1:
                    ref_xt = ref_xt[0:1,:,:,:]
                ref_xt = ddim_sample(start_latents=ref_xt,scheduler=self.scheduler,
                            unet=self.unet,
                            num_inference_steps=num_inference_steps,
                            do_classifier_free_guidance=do_classifier_free_guidance,
                            guidance_scale=1,
                            prompt_embeds=inversion_prompt,
                            t=t)
...
def ddim_inversion(
    ...
    return torch.cat(intermediate_latents),prompt_embeds
