...
if __name__=="__main__":
    ...
    model_path = "/home/zliu/SDWebUI/stable-diffusion-webui/models/Stable-diffusion/aingdiffusion_v170.safetensors"
    pipeline = StableDiffusionPipeline.from_single_file(pretrained_model_link_or_path=model_path,torch_dtype=torch.float16,
                                                        )
    # pipeline = StableDiffusionPipeline.from_pretrained(pretrained_model_name_or_path=model_path,
    ...
    input_image_filename = "initial_girl.png"
    ...
    with torch.no_grad():
        ...
        inverted_latents_image_pil.save("inv_sd15.png")
    ...
    image2 = cv2.imread('inv_sd15.png')
