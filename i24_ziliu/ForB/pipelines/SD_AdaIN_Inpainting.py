...
class StableDiffusionReferenceInpaintingPipeline(
    ...
    def __call__(
        ...
        pretrained_model_path ="/mnt/nfs-mnj-home-43/i24_ziliu/i24_ziliu/ForB/outputs/SD_Gen_Images/sd15_anime_specific_vae/ckpt_5001.pt"
