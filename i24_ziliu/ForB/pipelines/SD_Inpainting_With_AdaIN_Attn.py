        ...
        **kwargs,
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                # add noise to the reference latents
                ...
                # FIXME
                #latents = self.scheduler.step(noise_pred, t, ref_xt[1:,:,:,:], **extra_step_kwargs, return_dict=False)[0]
                
                
                middle_state_hidden_list.append(latents)
        ...
        if not return_dict:
            ...
            return (image, has_nsfw_concept,middle_state_hidden_list)
        
        return image,middle_state_hidden_list
