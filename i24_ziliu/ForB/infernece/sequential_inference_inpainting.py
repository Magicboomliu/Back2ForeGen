...
original_image_folder = "test_vae_changed/original_images"
foreground_image_folder = 'test_vae_changed/foreground_input'
officail_adain_results_folder = 'test_vae_changed/official_adaIN'
ours_adain_resuls_folder = 'test_vae_changed/ours_adaIN'
officail_attn_results_folder = 'test_vae_changed/officail_attn'
official_attn_atain_results_folder = 'test_vae_changed/official_attn_adin'
