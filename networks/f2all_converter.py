...
class CrossAttnDownBlock2D_Network(nn.Module):
    def __init__(self,in_channels_list=[320,640,1280]):
        ...
        for in_channels in self.in_channels_list:
            ...
            self.mean_layers.append(nn.Sequential(
                ...
                # nn.LayerNorm(in_channels // 2),  # Replace with LayerNorm
                nn.ReLU(),
                nn.Linear(in_channels // 2, in_channels),
                # nn.LayerNorm(in_channels)  # Replace with LayerNorm
            ))
    ...
    def forward(self, CrossAttnDownBlock2D_block_mean_list_1,
        ...
        CrossAttnDownBlock2D_block_mean_1 = torch.cat(CrossAttnDownBlock2D_block_mean_list_1,dim=0) #[2.320,1,1]
...
class DownBlock_Branch_Network(nn.Module):
    ...
    def forward(self,down_block_mean_list, down_block_var_list, down_block_feat_list):
...
class CrossAttnUpBlock2D_Network(nn.Module):
    def __init__(self,in_channels_list=[1280,640,320]):
    ...
    def forward(self, CrossAttnUpBlock2D_block_mean_list_1,
        ...
        CrossAttnUpBlock2D_block_mean_1 = torch.cat(CrossAttnUpBlock2D_block_mean_list_1,dim=0) #[2.320,1,1]
...
class F2All_Converter(nn.Module):
    ...
    def forward(self,mean_bank,var_bank,feat_bank):
        ...
        # mid_block_mean_list, mid_block_var_list,mid_block_feat_list
