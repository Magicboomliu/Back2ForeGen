...
if __name__=="__main__":
    ...
    prompt_fname ="/mnt/nfs-mnj-home-43/i24_ziliu/i24_ziliu/ForB/playground/Dataset_Configuration/NeverEndDream/Prompts/Generated_From_Template/never_end_dreams.txt"
    base_model_path = "/mnt/nfs-mnj-home-43/i24_ziliu/pretrained_models/base_models/neverend_dream.safetensors"
    ...
    for text_prompt in tqdm(prompts):
        ...
        image.save("/mnt/nfs-mnj-home-43/i24_ziliu/dataset/NeverEndDreams/images/{}.png".format(idx))
